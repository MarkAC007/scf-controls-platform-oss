...
def _run_gpt(prompt: str) -> ProviderResult:
    ...
    try:
        ...
        # "https://api.openai.com/v1/chat/completions" set on the Request object
        # above. The rule fires because it cannot see through the Request
        # wrapper to prove the destination is constant.
