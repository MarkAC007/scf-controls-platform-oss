    ...
    <div className={`recipe-card ${className}`}>
      <div className="recipe-card-header">
        ...
        {recipe.source === 'ai_generated' && (
          <div
            className="recipe-ai-badge"
            title="This guidance was generated by AI from vendor documentation. Verify steps against the vendor's current docs before relying on it."
          >
            {'⚠'} AI-generated — verify against vendor docs
          </div>
        )}
