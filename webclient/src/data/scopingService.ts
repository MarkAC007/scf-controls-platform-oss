  ...
  try {
    ...
    const data: ScopedControlsFile = {
      ...
      scoped_controls: scopedControls.map(control => ({
        ...
        out_of_scope_justification: control.out_of_scope_justification ?? undefined,
        scope_override: control.scope_override ?? undefined,
        scope_override_reason: control.scope_override_reason ?? undefined,
        scope_override_set_at: control.scope_override_set_at ?? undefined,
        scope_override_set_by: control.scope_override_set_by ?? undefined,
